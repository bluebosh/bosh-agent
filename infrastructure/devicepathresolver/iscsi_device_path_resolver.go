...
func (ispr iscsiDevicePathResolver) GetRealDevicePath(diskSettings boshsettings.DiskSettings) (string, bool, error) {
	err := ispr.checkDiskSettings(diskSettings.ISCSISettings)
	if err != nil {
...
func (ispr iscsiDevicePathResolver) checkDiskSettings(iSCSISettings boshsettings.ISCSISettings) error {
